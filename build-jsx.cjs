...
const SOURCES = [
  ...
  'upsell-pages.jsx',
  'pages-astro.jsx',
  // Telas XYZ migradas do Streamlit (vêm DEPOIS de pages-astro pra reusar XYZ* + _fmt*).
...
(function () {
  ...
  var PAGE_LABELS = {
    ...
    crm: '16 CRM',
    astro_dash: 'Demo · Dash',
    astro_dashfatur: 'Demo · Dash Faturamento',
    plano_acao: 'Demo · Plano de Ação',
    astro_giro: 'Demo · Giro Estoque',
    astro_frete: 'Demo · Frete RJ',
    astro_pedmin: 'Demo · Pedido Mínimo',
    astro_recompra: 'Demo · Recompra',
    astro_campanhas: 'Demo · Campanhas Ads',
    astro_agressividade: 'Demo · Agressividade',
    astro_abc: 'Demo · Curva ABC',
    pbi_tend_composicao: 'Demo · Tendência Composição',
    pbi_composicao_vendas: 'Demo · Composição de Venda',
    pbi_tend_produtos: 'Demo · Tendência Produtos',
    pbi_tend_marcas: 'Demo · Tendências Marcas',
    pbi_tend_temporais: 'Demo · Tendência Temporal',
    pbi_composicao_total: 'Demo · Composição de Venda (Total)',
    pbi_coorte: 'Demo · Cohort (Valor + Vendas)',
    pbi_analise_vendas: 'Demo · Análise de Vendas',
    pbi_campest: 'Demo · Campanha × Estado',
    pbi_vendas_dia_util: 'Demo · Vendas / Dia Útil',
    pbi_cfv: 'Demo · CFV (Custo Financeiro Venda)',
    pbi_geral: 'Demo · Visão Comercial Geral',
  };
  function App() {
    ...
    useEffect(function () {
      ...
      setDrilldown(null);
      // Expose pra pages XYZ lerem (ano-mes filter implicito)
